...
IMPORTANT NOTES: 
1. The backend endpoint host url is mentioned in environment.ts as well as environment.prod.ts. The property name is "apiUrl". PLEASE USE THIS PROPERTY WHEN YOU ARE TRYING TO CALL A BACKEND API. 
